...
export default function ScorecardScreen() {
  ...
  const [modalVisible, setModalVisible] = useState(false); // Add Player Modal
  const [newPlayerName, setNewPlayerName] = useState('');

  const [scoreModalVisible, setScoreModalVisible] = useState(false); // Score Entry Modal
          ...
          <View style={styles.headerRow}>
            ...
            {players.map((player, idx) => (
              <View key={idx} style={styles.cellWithRemove}>
                ...
                <Text style={styles.removeBtn} onPress={() => removePlayer(idx)}>
                  ✕
                </Text>
              </View>
            ))}
